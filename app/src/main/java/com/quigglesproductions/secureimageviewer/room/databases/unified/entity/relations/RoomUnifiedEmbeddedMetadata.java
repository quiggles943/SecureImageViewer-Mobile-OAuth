...
public class RoomUnifiedEmbeddedMetadata implements IFileMetadata {
    @Embedded
    public RoomUnifiedMetadata metadata;
    @Relation(parentColumn = "ArtistId",entityColumn = "ArtistId")
    public RoomUnifiedArtist artist;
    public RoomUnifiedEmbeddedMetadata(){}
