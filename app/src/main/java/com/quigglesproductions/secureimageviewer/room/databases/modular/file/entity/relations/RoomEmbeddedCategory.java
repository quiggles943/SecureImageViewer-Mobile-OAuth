...
public class RoomEmbeddedCategory  implements IDisplayFolder, IDatabaseFolder {
    @Embedded
    public RoomModularCategory category;
    @Relation(parentColumn = "CategoryId",entityColumn = "FileId",associateBy = @Junction(RoomModularFileCategoryCrossRef.class),entity = RoomModularFile.class)
