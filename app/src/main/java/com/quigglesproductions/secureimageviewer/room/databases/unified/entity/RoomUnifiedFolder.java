...
public class RoomUnifiedFolder implements IDisplayFolder, IRemoteFolder {
    ...
    public static class Creator{
        ...
        RoomUnifiedFolder databaseFolder;
        ...
        public RoomUnifiedFolder build(){
            return databaseFolder;
        }

        private RoomUnifiedFolder generateFolderFromOnlineFolder(ModularOnlineFolder onlineFolder){
            RoomUnifiedFolder folder = new RoomUnifiedFolder();
        ...
        private RoomUnifiedFolder generateFolderFromUnifiedFolder(RoomUnifiedFolder onlineFolder){
            RoomUnifiedFolder folder = new RoomUnifiedFolder();
            folder.onlineId = onlineFolder.onlineId;
            folder.encodedName = onlineFolder.encodedName;
            folder.normalName = onlineFolder.normalName;
        ...
        @NotNull
        public Creator loadFromUnifiedFolder(RoomUnifiedFolder onlineFolder) {
