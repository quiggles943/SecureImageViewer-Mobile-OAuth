...
public class RoomPagingFolder {
    ...
    public static class Creator{
        ...
        RoomPagingFolder databaseFolder;
        ...
        public RoomPagingFolder build(){
            return databaseFolder;
        }

        private RoomPagingFolder generateFolderFromOnlineFolder(ModularOnlineFolder onlineFolder){
            RoomPagingFolder folder = new RoomPagingFolder();
