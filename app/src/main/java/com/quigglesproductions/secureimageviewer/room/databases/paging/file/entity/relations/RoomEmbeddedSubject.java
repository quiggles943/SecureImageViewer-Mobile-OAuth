...
public class RoomEmbeddedSubject  implements IDisplayFolder, IDatabaseFolder {
    @Embedded
    public RoomPagingSubject subject;
    @Relation(parentColumn = "SubjectId",entityColumn = "FileId",associateBy = @Junction(RoomPagingFileSubjectCrossRef.class),entity = RoomPagingFile.class)
