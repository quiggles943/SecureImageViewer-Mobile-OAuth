...
public class RoomEmbeddedFile implements ItemBaseModel, IDatabaseFile {
    @Embedded
    public RoomModularFile file;
    @Relation(parentColumn = "FileId",entityColumn = "FileId",entity = RoomModularMetadata.class)
    public RoomEmbeddedMetadata metadata;
    @Relation(parentColumn = "FileId",entityColumn = "SubjectId",associateBy = @Junction(RoomModularFileSubjectCrossRef.class))
    public List<RoomModularSubject> subjects;
    @Relation(parentColumn = "FileId",entityColumn = "CategoryId",associateBy = @Junction(RoomModularFileCategoryCrossRef.class))
    public List<RoomModularCategory> categories;
    ...
    public RoomEmbeddedFile() {
        dataSource = new RoomModularFileDataSource(this);
    }
    ...
    public String getCatagoryListString() {
        if(metadata == null)
            ...
            if(categories != null && categories.size()>0) {
                for (RoomModularCategory category : categories) {
    ...
    public String getSubjectListString() {
        if(metadata == null)
            ...
            if(subjects != null && subjects.size()>0) {
                for (RoomModularSubject subject : subjects) {
    ...
    public static class Creator{
        ...
        RoomModularFile databaseFile;
        RoomEmbeddedMetadata metadata;
        RoomModularArtist artist;
        List<RoomModularCategory> categories;
        List<RoomModularSubject> subjects;
        ...
        private RoomEmbeddedMetadata generateMetadataFromOnlineFile(IFileMetadata fileMetadata) {
            ...
            RoomModularMetadata roomFileMetadata = new RoomModularMetadata();
        ...
        private RoomModularFile generateFileFromOnlineFile(ModularOnlineFile onlineFile){
            RoomModularFile databaseFile = new RoomModularFile();
        ...
        private RoomModularArtist generateArtistFromFileTag(IFileTag fileTag){
            RoomModularArtist artist = new RoomModularArtist();
            artist.setName(fileTag.getName());
            artist.setOnlineId(fileTag.getOnlineId());
            return artist;
        }
        private RoomModularCategory generateCategoryFromFileTag(IFileTag fileTag){
            RoomModularCategory artist = new RoomModularCategory();
            artist.setName(fileTag.getName());
            artist.setOnlineId(fileTag.getOnlineId());
            return artist;
        }

        private List<RoomModularCategory> generateCategoryListFromFileTags(List<IFileTag>fileTags){
            List<RoomModularCategory> categoryList = new ArrayList<>();
        ...
        private RoomModularSubject generateSubjectFromFileTag(IFileTag fileTag){
            RoomModularSubject artist = new RoomModularSubject();
            artist.setName(fileTag.getName());
            artist.setOnlineId(fileTag.getOnlineId());
            return artist;
        }

        private List<RoomModularSubject> generateSubjectListFromFileTags(List<IFileTag>fileTags){
            List<RoomModularSubject> subjectList = new ArrayList<>();
            for(IFileTag fileTag:fileTags){
