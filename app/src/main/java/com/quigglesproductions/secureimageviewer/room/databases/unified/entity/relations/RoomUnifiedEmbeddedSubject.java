...
public class RoomUnifiedEmbeddedSubject implements IDisplayFolder, IDatabaseFolder {
    @Embedded
    public RoomUnifiedSubject subject;
    @Relation(parentColumn = "SubjectId",entityColumn = "FileId",associateBy = @Junction(RoomUnifiedFileSubjectCrossRef.class),entity = RoomUnifiedFile.class)
    ...
    public RoomUnifiedEmbeddedSubject(){
