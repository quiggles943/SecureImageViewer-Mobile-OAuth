...
public class RoomModularFolderDataSource implements IFolderDataSource {

    private RoomEmbeddedFolder folder;
    private Context context;
    //private EnhancedDatabaseHandler databaseHandler;
    public RoomModularFolderDataSource(RoomEmbeddedFolder folder){
