...
public class SubjectDownloadTask extends AsyncTask<Void,SubjectModel,DownloaderResult<ArrayList<SubjectModel>>> {
    private String accessToken;
    private DownloadCompleteCallback<ArrayList<SubjectModel>, Exception> callback;
    public SubjectDownloadTask(String accessToken,DownloadCompleteCallback<ArrayList<SubjectModel>, Exception> callback){
        this.accessToken = accessToken;
        this.callback = callback;
    }
    @Override
    protected DownloaderResult<ArrayList<SubjectModel>> doInBackground(Void... voids) {
    ...
    @Override
    protected void onPostExecute(DownloaderResult<ArrayList<SubjectModel>> result) {
