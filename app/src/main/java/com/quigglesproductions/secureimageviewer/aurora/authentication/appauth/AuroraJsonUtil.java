 ...
 */
public final class AuroraJsonUtil {

    private AuroraJsonUtil() {
        ...
        try {
            if (value instanceof Collection) {
                ...
                for (String key : map.keySet()) {
                    AuroraJsonUtil.putIfNotNull(valueObj, key, map.get(key));
                }
    ...
    public static JSONObject mapToJsonObject(@NonNull Map<String, String> map) {
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            AuroraJsonUtil.put(json, entry.getKey(), entry.getValue());
        }
        return json;
    }

    public static <T> T get(JSONObject json, AuroraJsonUtil.Field<T> field) {
        try {
    ...
    public static <T> List<T> get(JSONObject json, AuroraJsonUtil.ListField<T> field) {
        try {
            if (!json.has(field.key)) {
                return field.defaultValue;
            }
    ...
    static final class UriField extends AuroraJsonUtil.Field<Uri> {
        /**
    ...
    static final class StringField extends AuroraJsonUtil.Field<String> {
        /**
    ...
    static final class BooleanField extends AuroraJsonUtil.Field<Boolean> {
    ...
    static final class StringListField extends AuroraJsonUtil.ListField<String> {
