...
public final class JsonUtil {
    ...
    public static <T> T get(JSONObject json, JsonUtil.Field<T> field) {
        try {
    ...
    public static <T> List<T> get(JSONObject json, JsonUtil.ListField<T> field) {
        try {
            if (!json.has(field.key)) {
                return field.defaultValue;
            }
    ...
    static final class UriField extends JsonUtil.Field<Uri> {
        /**
    ...
    static final class StringField extends JsonUtil.Field<String> {
        /**
    ...
    static final class BooleanField extends JsonUtil.Field<Boolean> {
    ...
    static final class StringListField extends JsonUtil.ListField<String> {
