 ...
 */
final class ViewerJsonUtil {

    private ViewerJsonUtil() {
        ...
        try {
            if (value instanceof Collection) {
                ...
                for (String key : map.keySet()) {
                    ViewerJsonUtil.putIfNotNull(valueObj, key, map.get(key));
                }
    ...
    public static JSONObject mapToJsonObject(@NonNull Map<String, String> map) {
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            ViewerJsonUtil.put(json, entry.getKey(), entry.getValue());
        }
        return json;
    }

    public static <T> T get(JSONObject json, ViewerJsonUtil.Field<T> field) {
        try {
    ...
    public static <T> List<T> get(JSONObject json, ViewerJsonUtil.ListField<T> field) {
        try {
            if (!json.has(field.key)) {
                return field.defaultValue;
            }
    ...
    static final class UriField extends ViewerJsonUtil.Field<Uri> {
        /**
    ...
    static final class StringField extends ViewerJsonUtil.Field<String> {
        /**
    ...
    static final class BooleanField extends ViewerJsonUtil.Field<Boolean> {
    ...
    static final class StringListField extends ViewerJsonUtil.ListField<String> {
