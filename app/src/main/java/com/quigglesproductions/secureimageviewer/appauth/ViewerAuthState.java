...
public class ViewerAuthState extends AuthState {
    ...
    public ViewerAuthState(@NonNull AuthorizationServiceConfiguration config){
        this.authState = new AuthState(config);
    }
    public ViewerAuthState(AuthState authState){
        this.authState = authState;
    }
    public ViewerAuthState(ViewerAuthState viewerAuthState){
        this.authState = viewerAuthState.authState;
    }

    public ViewerAuthState() {
    ...
    public static ViewerAuthState jsonDeserialize(@NonNull String jsonStr) throws JSONException {
    ...
    public JSONObject jsonSerialize() {
        ...
        ViewerJsonUtil.putIfNotNull(json, KEY_REFRESH_TOKEN, getRefreshToken());
        ViewerJsonUtil.putIfNotNull(json,KEY_REFRESH_TOKEN_EXPIRATION,getRefreshTokenExpirationTime());
        ViewerJsonUtil.putIfNotNull(json, KEY_SCOPE, getScope());

        if (getAuthorizationServiceConfiguration() != null) {
            ViewerJsonUtil.put(json, KEY_CONFIG, getAuthorizationServiceConfiguration().toJson());
        }

        if (getAuthorizationException() != null) {
            ViewerJsonUtil.put(json, KEY_AUTHORIZATION_EXCEPTION, getAuthorizationException().toJson());
        }
     ...
     */
    public static ViewerAuthState jsonDeserialize(@NonNull JSONObject json) throws JSONException {
        checkNotNull(json, "json cannot be null");
        ViewerAuthState authState = new ViewerAuthState();
